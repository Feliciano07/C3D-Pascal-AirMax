...
namespace C3D_Pascal_AirMax.Expresion.Relacionales
{
    public class Igual : Nodo
    {
        ...
        public override Retorno compilar(Entorno entorno)
        {
            ...
            switch (res_left.getTipo())
            {
                ...
                default: 
                   ...
                   "No se puede aplicar operador igual a tipos de datos " + res_left.getTipo().ToString());
                    Master.getInstancia.addError(error);
                    throw new Exception("No se puede aplicar operador igual a tipos de datos " + res_left.getTipo().ToString());
            }
        ...
        public Retorno Llamada_Nativa_Comparar(Retorno res_left, Retorno res_right, int size)
        {
            ...
            Master.getInstancia.callFuncion("native_comparar_str");
