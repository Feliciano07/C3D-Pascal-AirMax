...
{
    public class Nativa_Igual : Nodo
    {

        public Nativa_Igual(int linea, int columna) : base(linea, columna)
        {
        ...
        public void Igual_String()
        {
            Master.getInstancia.addFuncion("native_comparar_str");
